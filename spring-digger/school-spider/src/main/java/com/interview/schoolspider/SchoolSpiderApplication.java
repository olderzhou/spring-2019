...
//    public void receive3(List<ConsumerRecord<String, SchoolSpiderVo>> record) {
//        log.info("receive3 data is :{}", record);
//    }

//    @KafkaListener(groupId = "test3", topics = "schoo-topic-1")
//    public void receive4(List<ConsumerRecord<String, SchoolSpiderVo>> record) {
//        log.info("receive4 data is :{}", record);
//    }

    @KafkaListener(id = "test3", topics = {"test-topic", "test-topic-1", "test-topic-a"})
    public void receive5(List<ConsumerRecord<String, SchoolSpiderVo>> record) {
    ...
    public void receive6(List<ConsumerRecord<String, SchoolSpiderVo>> record) {
        record.stream().forEach(i -> {
    ...
    public void receive7(List<ConsumerRecord<String, SchoolSpiderVo>> record) {
        record.stream().forEach(i -> {
