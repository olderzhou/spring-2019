package com.klaus.interview.commonbase.po.vo;

import com.fasterxml.jackson.annotation.JsonIgnore;
import com.fasterxml.jackson.annotation.JsonInclude;
import com.klaus.interview.commonbase.error.ErrorType;
...
public class R<T> {
     ...
     * @param data
     */
    private R(String code, String mesg, T data) {
        this.code = code;
        this.mesg = mesg;
        this.data = data;
        this.timestamp = ZonedDateTime.now().toInstant().toEpochMilli();
    ...
    public static R fail() {
        return new R(SystemErrorType.SYSTEM_ERROR);
    }
